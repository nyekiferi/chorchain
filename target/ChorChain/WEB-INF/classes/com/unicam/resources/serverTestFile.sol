...
function sid_624ca53e_cc27_4a74_97be_055cb19cae54(uint price) public checkRole(optionalList[0]){
...
optionalRoles["Seller"].transfer(msg.value);
...
function sid_2F272EDB_9940_467E_AADC_2B485679AF43(string memory shipInfo) public checkRole(optionalList[0]) {
...
function sid_06caa7c5_fba5_4524_8d4d_2f24b1d51468(string memory invoiceInfo) public checkRole(optionalList[0]) {
